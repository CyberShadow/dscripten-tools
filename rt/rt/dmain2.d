...
{
    version = HaveSections;
    version = HaveMonitors;
}
...
extern (C) int rt_init()
{
    ...
    try
    {
        ...
        version(dscripten) {} else // TODO
        _d_initMonoTime();
        gc_init();
        version(HaveSections)
            initStaticDataGC();
        lifetime_init();
        version(HaveSections) // TODO find some other way to initialize module infos
        {
            rt_moduleCtor();
            rt_moduleTlsCtor();
        }
